...
VOCS_TITLE = "GSRSD Vocabularies"
VOCS_URI = "http://www.geoscience.gov.au/data-standards/ggic-vocab-register"
VOCS_DESC = "Vocabularies managed and published by the Geological Survey and Resource Strategy Division of Western Australia (GSRSD)"
